...
const COL0_MASK: u128 = (1u128 << 0)  | (1u128 << 9)  | (1u128 << 18) | (1u128 << 27)
                      | (1u128 << 36) | (1u128 << 45) | (1u128 << 54) | (1u128 << 63)
                      | (1u128 << 72);
const COL8_MASK: u128 = (1u128 << 8)  | (1u128 << 17) | (1u128 << 26) | (1u128 << 35)
                      | (1u128 << 44) | (1u128 << 53) | (1u128 << 62) | (1u128 << 71)
                      | (1u128 << 80);
...
impl Board {
    pub(super) fn state_valid(&self) -> bool {
        ...
        while visited != prev_visited {
            ...
            let white_mask_right = ((white_mask & !COL8_MASK) << 1) & !(self.walls.walls_right << 1);
